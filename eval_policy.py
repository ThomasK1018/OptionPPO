...
def rollout(policy, env, n_episode, render):
	"""
...
def eval_policy(policy, env, n_episode, render=False):
	"""
	...
	for ep_num, (ep_len, ep_ret) in enumerate(rollout(policy, env, n_episode, render)):
